...
export BROKER_SERVICE_PORT_INTERNAL_ENV=BROKER_${HOSTNAME##*-}_SERVICE_PORT
...
/opt/kafka_2.13-2.5.1/bin/kafka-server-start.sh /opt/kafka_2.13-2.5.1/config/server.properties \
	...
	--override listeners=INTERNAL://:${KAFKA_SERVICE_PORT_INTERNAL},EXTERNAL://:${KAFKA_SERVICE_PORT_EXTERNAL} \
	--override advertised.listeners=INTERNAL://${BROKER_SERVICE_HOST_INTERNAL}:${KAFKA_SERVICE_PORT_INTERNAL},EXTERNAL://${BROKER_SERVICE_HOST_EXTERNAL}:${BROKER_SERVICE_PORT_EXTERNAL} \
